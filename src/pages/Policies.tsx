                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      {policy.vehicle_info?.chassis_number && (
                        <div>
                          <span className="text-muted-foreground">Chassis:</span>
                          <p className="font-medium font-mono text-xs">{policy.vehicle_info.chassis_number}</p>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                {policy.owner_info && (
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      {policy.owner_info.name && (
                        <div>
                          <span className="text-muted-foreground">Name:</span>
                          <p className="font-medium">{policy.owner_info.name}</p>
                        </div>
                      )}
                      {policy.owner_info.email && (
                        <div>
                          <span className="text-muted-foreground">Email:</span>
                          <p className="font-medium">{policy.owner_info.email}</p>
                        </div>
                      )}
                      {policy.owner_info.phone && (
                        <div>
                          <span className="text-muted-foreground">Phone:</span>
                          <p className="font-medium">{policy.owner_info.phone}</p>
                        </div>
                      )}
                    </div>
                  </div>
